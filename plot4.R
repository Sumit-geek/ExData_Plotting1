...
febDaysData$Global_reactive_power <- as.numeric(febDaysData$Global_reactive_power)
febDaysData$Voltage <- as.numeric(febDaysData$Voltage)
...
plot(datetime, febDaysData$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)

plot(datetime, febDaysData$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=1, cex=1, col=c("black", "red", "blue"), bty="n")

plot(datetime, febDaysData$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
